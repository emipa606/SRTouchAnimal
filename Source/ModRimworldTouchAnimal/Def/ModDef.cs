...
public static class ModDef
{
    ...
    public static readonly Color BilibiliPink = new Color(0.984f, 0.447f, 0.6f, 0.4f);
    public static readonly Color BilibiliBlue = new Color(0.137f, 0.769f, 0.898f, 0.4f);
